...
**Is this just a shorter-output command?**

No. It asks the agent to repair comprehension: add the missing premise, reuse the project's vocabulary, and shorten only what obscures the point.
